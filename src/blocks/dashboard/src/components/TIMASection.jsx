...
const cet =
	"With participating in our online community you will earn some tokens. For each comment you get a token of your choosing and answering to a survey also gives you 1 complete set of tokens."

const det =
	"There are charities that work with youth and we like them. with every donation you will receive a complete set of tokens. You can find their list in your profile."
