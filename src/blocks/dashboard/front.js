...
window.addEventListener("DOMContentLoaded", () => {
  ...
  const providerValues = {
    ...
    nonce: root.dataset.nonce,
		...
		latestClasses: JSON.parse(
			document.getElementById("latest-classes").innerHTML
		),
		allClasses: JSON.parse(document.getElementById("all-classes").innerHTML),
		analyzedClasses: JSON.parse(
...
`
	...
	render(
		<>
			<App providerValues={providerValues} assetPath={assetPath} />
			<GlobalStyles />
		</>,
		root
	)
